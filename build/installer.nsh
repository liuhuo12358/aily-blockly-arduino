...
!macro customInstall
  ...
  nsExec::ExecToStack '"$INSTDIR\resources\app\child\7za.exe" x "$INSTDIR\resources\app\child\aily-builder-1.0.2.7z" -o"$INSTDIR\resources\app\child\aily-builder" -y'
